...
- Antiquity: **Warrior Class**
	...
	- +1 Gold for every Unit packed into Commanders
- Exploration: **Professional Army**
	- +25% XP for all Commanders, or +50% in Distant Lands
- Modern: **Force Structuring**
	- +25% towards constructing Military Buildings

#### Diplomacy
Militaristic Leaders gain access to the below diplomatic actions
- Endeavor: **Military Aid**
	- Accepted
		- Your units gain +2 Combat Strength, and the receiver gains +2 Gold per turn
	- Supported
		- Both Leaders' units gain +3 Combat Strength
- Sanction: **Hinder Military Production**
	- Target's Military Units cost +20% more Production to train
